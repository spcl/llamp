                                                     ...
                                                     void *user_data)
{
    ...
    rreq->recv_time.tv_sec  = info->recv_time.tv_sec;
    rreq->recv_time.tv_nsec = info->recv_time.tv_nsec;
                                                      ...
                                                      void *user_data)
{
    ...
    rreq->recv_time.tv_sec  = info->recv_time.tv_sec;
    rreq->recv_time.tv_nsec = info->recv_time.tv_nsec;
    printf("[DEBUG] Recv time in mrecv cmpl callback: %ld:%ld\n", rreq->recv_time.tv_sec, rreq->recv_time.tv_nsec);
