...
struct req_wrapper
{
  bool is_fast_complete;
  MPIR_Request *req;
  struct timespec end;
};

extern int delay_queue_read;
extern int delay_queue_write;
extern atomic_int terminate_req_thread;
extern int delay;
extern atomic_int queue_size;
extern pthread_mutex_t req_thread_lock;
extern struct req_wrapper delay_queue[MAX_QUEUE_SIZE];
/** <Variables used by the delay request handler thread> **/
