...
CC=$MPICC FC=$MPIFC CFLAGS=-fPIC CPPFLAGS=-I$HDF5_INSTALL_DIR/include LDFLAGS=-L$HDF5_INSTALL_DIR/lib ./configure --enable-parallel-tests --prefix=$NETCDF_FORTRAN_INSTALL_DIR
if [ $? -ne 0 ]; then
